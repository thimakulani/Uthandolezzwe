<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Details.aspx.cs" Inherits="Uthandolezzwe.Views.Tenders.Details" %>
                ...
                <form enctype="multipart/form-data" runat="server" class="form-horizontal" method="post">
                    ...
                    <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                            <asp:Button runat="server" ID="BtnCreateTender" Text="Create Tender" class="btn-sm btn-primary"  />
                            <asp:Button runat="server" ID="BtnUpdateTender" Text="Update Tender" class="btn-sm btn-info" OnClick="BtnUpdateTender_Click"  />
                            <asp:Button runat="server" ID="BtnDeleteTender" Text="Delete Tender" class="btn-sm btn-danger"  />
                        </div>
                    </div>
                </form>
                <!-- /.tender-form -->
